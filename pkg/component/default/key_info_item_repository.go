...
type KeyInfoItemRepository struct {
	config         *KeyInfoItemRepositoryConfig
	baseRepository *sqlrepository.BaseRepository
}

type KeyInfoItemRepositoryConfig struct {
	SQLClientWrapper *sqlutil.SQLClientWrapper `mapstructure:"sqlite-client-wrapper"`
}

func NewKeyInfoItemRepositoryWithConfig(properties confg.Confg) (*KeyInfoItemRepository, error) {
	config := KeyInfoItemRepositoryConfig{}
	...
	return NewKeyInfoItemRepository(&KeyInfoItemRepositoryConfig{
		SQLClientWrapper: sqliteClientWrapper,
	})
}

func NewKeyInfoItemRepository(config *KeyInfoItemRepositoryConfig) (*KeyInfoItemRepository, error) {
	inst := &KeyInfoItemRepository{
		config: config,
	}
...
func (inst *KeyInfoItemRepository) FindAllProcessed(userContext entity.UserContext) (int64, []models.KeyInfoItem, error) {
	result := []models.KeyInfoItem{}
...
func (inst *KeyInfoItemRepository) FindAll(userContext entity.UserContext, findRequest *entity.FindRequest) (int64, []models.KeyInfoItem, error) {
	result := []models.KeyInfoItem{}
	if findRequest == nil {
...
func (inst *KeyInfoItemRepository) Create(userContext entity.UserContext, item *models.KeyInfoItem) error {
...
func (inst *KeyInfoItemRepository) FindLast(userContext entity.UserContext, findRequest *entity.FindRequest) (*models.KeyInfoItem, error) {
	result := &models.KeyInfoItem{}
	if findRequest == nil {
		findRequest = &entity.FindRequest{}
	}
...
func (inst *KeyInfoItemRepository) Delete(userContext entity.UserContext, filters map[string]interface{}) error {
	item := &models.KeyInfoItem{}
...
func (inst *KeyInfoItemRepository) DeleteByUUID(userContext entity.UserContext, item models.KeyInfoItem) error {
	baseItem := &models.KeyInfoItem{}
...
func (inst *KeyInfoItemRepository) UpdateByUUID(userContext entity.UserContext, item *models.KeyInfoItem) error {
