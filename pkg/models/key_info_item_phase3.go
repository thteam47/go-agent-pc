...
type KeyInfoItemPhase3 struct {
	...
	KeyPublicItemPhase3Id string    `bson:"key_public_item_phase3_id,omitempty" json:"key_public_item_phase3_id,omitempty"`
...
func (keyInfo *KeyInfoItemPhase3) BeforeCreate(tx *gorm.DB) {
